...
{
    public partial class FrmKarsidanAntrenmanlar : Form
    {
        ...
        public int id;
        private int s;
        public FrmKarsidanAntrenmanlar()
        {
            InitializeComponent();
        }
        ...
        private void btnFiltrele_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    arananDeger = DbService.GetFilteredValue(id, 1, Convert.ToInt32(cmbAra.SelectedValue), dtimeBaslangic, dtimeBitis);
                }
                else if (dtimeBaslangic?.Value != null && dtimeBitis?.Value != null)
                {
                    arananDeger = DbService.GetFilteredValueOnlyDate(Context.sporcu.Id, 1, dtimeBaslangic, dtimeBitis);
                }
        ...
        private void btnSifirla_Click(object sender, EventArgs e)
        {
            ...
            var antrenmanlar = DbService.GetPractices(Context.sporcu.Id, 1);
        ...
        private void FrmKarsidanAntrenmanlar_Load(object sender, EventArgs e)
        {
        ...
        private void cmbAra_MouseClick_1(object sender, MouseEventArgs e)
        {
            s++;
